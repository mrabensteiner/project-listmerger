...
\newcommand{\thisdate}{03 Jul 2026}  % date of this version
...
\end{center}
ListMerger is a TypeScript-written JavaScript library to facilitate the
merging of multiple, multi-dimensional lists. An application example is
the merging of findings from evaluators in a heuristic evaluation. The
library bases primarily on modern usage of HTML, CSS, and JavaScript,
and largely avoids third-party plugins. This project report contains a
description of the implementation, a brief introduction into the
techniques and use cases, and user guides for implementors, and
end-users.
\end{quote}
