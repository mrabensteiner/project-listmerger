...
%  File    :  survey.tex
%
%  Author  :  Martin Rabensteiner; Keith Andrews, ISDS, TU Graz, Austria
%
%  Created :  24 Mar 2010
%
%  Changed :  24 Jun 2026
...
\newcommand{\thistitle}{ListMerger: A JavaScript Component for Manual List Merging}  % title
...
\newcommand{\thisauthor}{Martin Rabensteiner}          % author
% \newcommand{\thisauthor}{Keith Andrews, Tom Black, and Harry White}      % multiple authors
\newcommand{\thiskeywords}{TypeScript, JavaScript, list merging,
drag-and-drop, user interface}   % keywords

\newcommand{\thisdate}{24 Jun 2026}  % date of this version
...
\newcommand{\quarterh}{4cm}       % height of figures for 4 per page
...
\definecolor{darkgreen}{rgb}{0.0,0.15,0.0}
\definecolor{darkblue}{rgb}{0.0,0.0,0.2}
\definecolor{darkred}{rgb}{0.17,0.0,0.0}
...
% D is like X but centered table cells
...
\lstdefinelanguage{biblatex}   % based on biblatex v 2.7a from 2013-07-14
{
  keywords={%
    ...
    @conference,@electronic,@mastersthesis,@bachelorsthesis,@phdthesis,%
    @techreport,@www,%
...
[7.0em]%                         % left indent to entry text = 3.8 + 3.2
{}%                              % above-code per entry
{3.2em}%                         % label width
{1pc}%                           % space around the dots
...
\SetCiteCommand{\parencite}    % or maybe \parencite
...
\end{center}
ListMerger is a TypeScript-written JavaScript library to facilitate
the merging of multiple lists. An application example is the merging of
findings from multiple evaluators in a heuristic evaluation. The library
bases primarily on modern usage of HTML, CSS, and JavaScript, and
largely avoids third-party plugins. This paper contains a description of
the implementation, a brief introduction into the techniques and use
cases, and user guides for developers, implementors, and end-users.
\end{quote}
...
\cleardoublepage
\input{project-listmerging}

\cleardoublepage
\input{project-webtech}

\cleardoublepage
\input{project-listmerger}

\appendix
\cleardoublepage
\input{project-guide-enduser}

\cleardoublepage
\input{project-guide-libuser}
